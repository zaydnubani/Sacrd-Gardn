...
for(let i=0;i<bio.length;i++){
    bio[i].addEventListener('click', (event) => {
        ...
        if(screen.width >= 1400){
            bio[i].style = `width:100%; height:100%; font-size:1.75rem; overflow-y:scroll; z-index:1; padding:2%;`;
        } else if(screen.width >= 1200) {
            bio[i].style = 'width:100%; height:100%; font-size:1.4rem; overflow-y:scroll; z-index:1; padding:1%';
        }  else if(screen.width >= 992) {
            bio[i].style = 'width:100%; height:100%; font-size:1.2rem; overflow-y:scroll; z-index:1; padding:2%';
        } else if(screen.width >= 768) {
            bio[i].style = 'width:100%; height:100%; font-size:1.2rem; overflow-y:scroll; z-index:1; padding-right:5%; padding-top:5%;';
